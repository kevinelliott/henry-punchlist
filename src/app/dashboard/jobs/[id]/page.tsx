...
const demoItems = [
  {
    ...
    status: 'approved' as 'open' | 'in_progress' | 'completed' | 'approved' | 'rejected',
  ...
  },
  {
    ...
    status: 'completed' as 'open' | 'in_progress' | 'completed' | 'approved' | 'rejected',
  ...
  },
  {
    ...
    status: 'in_progress' as 'open' | 'in_progress' | 'completed' | 'approved' | 'rejected',
  ...
  },
  {
    ...
    status: 'open' as 'open' | 'in_progress' | 'completed' | 'approved' | 'rejected',
